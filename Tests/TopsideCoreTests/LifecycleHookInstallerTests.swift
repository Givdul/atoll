...
final class LifecycleHookInstallerTests: XCTestCase {
    ...
    func testInstallsEverySupportedIntegrationIdempotently() throws {
        ...
        XCTAssertTrue(pi.contains("before_agent_start"))
        XCTAssertTrue(pi.contains("event.prompt"))
        ...
        XCTAssertTrue(pi.contains("emit(outcome, ctx, promptFor(ctx))"))
        XCTAssertTrue(pi.contains("typeof prompt === \"string\""))
        ...
        XCTAssertTrue(openCode.contains("event.type === \"session.updated\""))
        XCTAssertTrue(openCode.contains("event.type === \"message.updated\""))
        XCTAssertTrue(openCode.contains("event.type === \"message.part.updated\""))
        XCTAssertTrue(openCode.contains("payload.title = titles.get(sessionID)"))
        XCTAssertTrue(openCode.contains("payload.prompt = prompts.get(sessionID)"))
