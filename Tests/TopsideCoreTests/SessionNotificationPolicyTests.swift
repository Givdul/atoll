...
final class SessionNotificationPolicyTests: XCTestCase {
    func testOnlyNewActionableTransitionsNotify() {
        ...
        XCTAssertEqual(
            ...
            [SessionNotification(
                identifier: "topside.session.waitingForInput",
    ...
    func testLegacyNotificationCleanupMatchesOnlyOwnedPrefixes() {
        XCTAssertTrue(SessionNotificationPolicy.isLegacyOwnedIdentifier("skerry.session.failed"))
        XCTAssertTrue(SessionNotificationPolicy.isLegacyOwnedIdentifier("atoll.session.failed"))
        XCTAssertFalse(SessionNotificationPolicy.isLegacyOwnedIdentifier("topside.session.failed"))
        XCTAssertFalse(SessionNotificationPolicy.isLegacyOwnedIdentifier("com.example.skerry.session"))
        XCTAssertFalse(SessionNotificationPolicy.isLegacyOwnedIdentifier("skerryish.session"))
    }
