...
final class PrivateStorageTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        homeDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("SkerryPrivateStorageTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testQueueCreatesAndRepairsUserOnlyModes() throws {
        ...
        let root = homeDirectory.appendingPathComponent(".skerry", isDirectory: true)
    ...
    func testAtomicWriteSupportsAnExistingPrivateParentDirectory() throws {
        let target = FileManager.default.temporaryDirectory
            .appendingPathComponent("SkerryPrivateAtomic-\(UUID().uuidString).json")
