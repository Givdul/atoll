...
/// Durable proof that Topside accepted a validated local event from a provider.
...
public final class LifecycleRuntimeEvidenceStore: @unchecked Sendable {
    ...
    public init(homeDirectory: URL = FileManager.default.homeDirectoryForCurrentUser) {
        fileURL = homeDirectory.appendingPathComponent(".topside/lifecycle-runtime-evidence.json")
