...
public struct LifecycleEvent: Hashable, Sendable {
    ...
    /// Skerry-generated transport identity. It remains stable through socket and
    ...
    /// Normalizes the JSON delivered on stdin by a native hook into Skerry's protocol.
