...
public final class LifecycleSessionRegistry: @unchecked Sendable {
    ...
    private struct Record: Codable {
        ...
        var updatedAt: Date
        /// Local time when Skerry accepted the current state. Optional so
    ...
    public init(
        ...
        self.hardensParentDirectory = fileURL.deletingLastPathComponent().lastPathComponent == ".skerry"
    ...
    private static func load(from fileURL: URL) -> (records: [String: Record], needsRewrite: Bool) {
        ...
        if directory.lastPathComponent == ".skerry" {
