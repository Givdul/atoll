...
/// Durable proof that Skerry accepted a validated local event from a provider.
...
public final class LifecycleRuntimeEvidenceStore: @unchecked Sendable {
    ...
    public init(homeDirectory: URL = FileManager.default.homeDirectoryForCurrentUser) {
        fileURL = homeDirectory.appendingPathComponent(".skerry/lifecycle-runtime-evidence.json")
